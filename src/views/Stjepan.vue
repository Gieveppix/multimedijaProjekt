...
<template>
    ...
    <div class="flex flex-row justify-between">
        <div class="hover-pointer">
            <img src="../assets/kosarka1.gif" width="350" height="230" @click="() => openGifDialog()">
        </div>
        <div class="hover-pointer">
            <img src="../assets/kosarka-slika1.jpeg" width="350" height="230" alt="" @click="() => openImgDialog()">
        </div>
        <div class=" hover-pointer">
    ...
    <div class="center-content">
        <audio controls>
            <source src="../assets/kosarka-stjepan-sound-bavim-se-kosarkom.ogg" type="audio/ogg">
            <source src="../assets/kosarka-stjepan-sound-bavim-se-kosarkom.mp3" type="audio/mpeg">
